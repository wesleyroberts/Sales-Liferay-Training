...
public interface TypeResource {
	...
	public HttpInvoker.HttpResponse updateTypeByIdHttpResponse(
			Integer typeId, TypeInput typeInput)
		throws Exception;
	...
	public static class Builder {
		...
		public TypeResource build() {
			return new TypeResourceImpl(this);
		}
	...
	public static class TypeResourceImpl implements TypeResource {
		...
		public Page<Type> getAllTypes() throws Exception {
			...
			try {
				return Page.of(content, TypeSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getAllTypesHttpResponse()
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/RestBuilder/v1.0/type/all");
		...
		public Type getTypeById(Integer typeId) throws Exception {
			...
			try {
				return TypeSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getTypeByIdHttpResponse(Integer typeId)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/RestBuilder/v1.0/type/{typeId}");

			httpInvoker.path("typeId", typeId);
		...
		public Type updateTypeById(Integer typeId, TypeInput typeInput)
			...
			HttpInvoker.HttpResponse httpResponse = updateTypeByIdHttpResponse(
				typeId, typeInput);
		...
		public HttpInvoker.HttpResponse updateTypeByIdHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/RestBuilder/v1.0/type/update/{typeId}");
		...
		public HttpInvoker.HttpResponse deleteTypeByIdHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/RestBuilder/v1.0/type/delete/{typeId}");
		...
		private TypeResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			TypeResource.class.getName());
