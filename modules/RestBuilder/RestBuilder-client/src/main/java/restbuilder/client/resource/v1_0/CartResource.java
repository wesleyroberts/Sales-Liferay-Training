...
public interface CartResource {
	...
	public HttpInvoker.HttpResponse finishBuyHttpResponse(Integer cartID)
		throws Exception;
	...
	public static class CartResourceImpl implements CartResource {
		...
		public Cart finishBuy(Integer cartID) throws Exception {
			HttpInvoker.HttpResponse httpResponse = finishBuyHttpResponse(
				cartID);
		...
		public HttpInvoker.HttpResponse finishBuyHttpResponse(Integer cartID)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/RestBuilder/v1.0/finishBuy/CartId/{cartID}");
