...
import restbuilder.client.resource.v1_0.CategoryResource;
...
public abstract class BaseCategoryResourceTestCase {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (Field field :
				getDeclaredFields(restbuilder.dto.v1_0.Category.class)) {
	...
	@Inject
	private restbuilder.resource.v1_0.CategoryResource _categoryResource;
