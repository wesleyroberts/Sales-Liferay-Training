...
@Generated("")
@Path("/v1.0")
public abstract class BaseProductInputResourceImpl
	implements EntityModelResource, ProductInputResource,
			   VulcanBatchEngineTaskItemDelegate<ProductInput> {
	...
	public void create(
			java.util.Collection<ProductInput> productInputs,
