...
@Generated("")
@Path("/v1.0")
public abstract class BaseCartOutputResourceImpl
	implements CartOutputResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<CartOutput> {
	...
	public void create(
			java.util.Collection<CartOutput> cartOutputs,
