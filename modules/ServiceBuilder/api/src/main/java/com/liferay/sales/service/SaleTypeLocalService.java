...
/**
 * Provides the local service interface for SaleType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SaleTypeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SaleTypeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.sales.service.impl.SaleTypeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sale type local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SaleTypeLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SaleType deleteSaleType(long typeId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SaleType fetchSaleType(long typeId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SaleType> getSaleTypes(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SaleType updateSaleType(SaleType saleType);
