...
/**
 * Provides the remote service interface for SaleProduct. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see SaleProductServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface SaleProductService extends BaseService {
