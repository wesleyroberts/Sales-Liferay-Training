...
public class SaleStockUtil {
	 ...
	 */
	public static SaleStock fetchByName_Type_Category(
		String name, long typeId, long categoryId) {

		return getPersistence().fetchByName_Type_Category(
			name, typeId, categoryId);
	}
	...
	public static SaleStock fetchByName_Type_Category(
		...
		return getPersistence().fetchByName_Type_Category(
			name, typeId, categoryId, useFinderCache);
	}
	 ...
	 */
	public static SaleStock removeByName_Type_Category(
			String name, long typeId, long categoryId)
		throws com.liferay.sales.exception.NoSuchSaleStockException {

		return getPersistence().removeByName_Type_Category(
			name, typeId, categoryId);
	}
	 ...
	 */
	public static int countByName_Type_Category(
		String name, long typeId, long categoryId) {

		return getPersistence().countByName_Type_Category(
			name, typeId, categoryId);
	}
