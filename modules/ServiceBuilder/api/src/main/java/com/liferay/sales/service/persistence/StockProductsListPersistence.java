...
/**
 * The persistence interface for the stock products list service.
 *
 * <p>
 ...
 * @see StockProductsListUtil
 * @generated
 */
@ProviderType
public interface StockProductsListPersistence
	extends BasePersistence<StockProductsList> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StockProductsListUtil} to access the stock products list persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<StockProductsList> stockProductsLists);
	 ...
	 */
	public java.util.List<StockProductsList> findAll();
	 ...
	 */
	public java.util.List<StockProductsList> findAll(int start, int end);
	...
	public java.util.List<StockProductsList> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<StockProductsList>
			orderByComparator);
