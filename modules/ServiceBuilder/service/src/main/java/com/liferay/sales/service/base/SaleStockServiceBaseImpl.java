...
/**
 * Provides the base implementation for the sale stock remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.sales.service.impl.SaleStockServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.sales.service.impl.SaleStockServiceImpl
 * @generated
 */
public abstract class SaleStockServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SaleStockService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SaleStockService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SaleStockServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SaleStockService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		saleStockService = (SaleStockService)aopProxy;

		_setServiceUtilService(saleStockService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SaleStockService.class.getName();
	}
	...
	private void _setServiceUtilService(SaleStockService saleStockService) {
		try {
			Field field = SaleStockServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, saleStockService);
		}
	...
	@Reference
	protected com.liferay.sales.service.SaleStockLocalService
