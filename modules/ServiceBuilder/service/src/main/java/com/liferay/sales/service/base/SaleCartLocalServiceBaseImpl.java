...
import com.liferay.sales.service.SaleCartLocalService;
...
/**
 * Provides the base implementation for the sale cart local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.sales.service.impl.SaleCartLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.sales.service.impl.SaleCartLocalServiceImpl
 * @generated
 */
public abstract class SaleCartLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, SaleCartLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SaleCartLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SaleCartLocalServiceUtil</code>.
	 */
	...
	public SaleCart createSaleCart(long cartId) {
		return saleCartPersistence.create(cartId);
	}
	...
	public SaleCart deleteSaleCart(long cartId) throws PortalException {
		return saleCartPersistence.remove(cartId);
	}
	...
	public SaleCart deleteSaleCart(SaleCart saleCart) {
		return saleCartPersistence.remove(saleCart);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SaleCart.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return saleCartPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return saleCartPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return saleCartPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return saleCartPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SaleCart fetchSaleCart(long cartId) {
		return saleCartPersistence.fetchByPrimaryKey(cartId);
	}
	...
	public SaleCart getSaleCart(long cartId) throws PortalException {
		return saleCartPersistence.findByPrimaryKey(cartId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(saleCartLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SaleCart.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			saleCartLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SaleCart.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return saleCartPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return saleCartLocalService.deleteSaleCart((SaleCart)persistedModel);
	}

	public BasePersistence<SaleCart> getBasePersistence() {
		return saleCartPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return saleCartPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SaleCart> getSaleCarts(int start, int end) {
		return saleCartPersistence.findAll(start, end);
	}
	...
	public int getSaleCartsCount() {
		return saleCartPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SaleCartLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		saleCartLocalService = (SaleCartLocalService)aopProxy;

		_setLocalServiceUtilService(saleCartLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SaleCartLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = saleCartPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = SaleCartLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, saleCartLocalService);
		}
	...
	protected SaleCartLocalService saleCartLocalService;
