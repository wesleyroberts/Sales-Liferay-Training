...
export default function TypeEditModal({
  showEditModalType,
  setShowEditModalType,
  objModalEditType,
}) {
  const { observer, onClose } = useModal({
    onClose: () => setShowEditModalType(false),
  });
  return (
    <div>
      {showEditModalType && (
          ...
          <ClayModal.Body>
            <ClayForm>
              <ClayForm.Group className="form-group-sm">
                ...
                <ClayInput
                  type="text"
                  defaultValue={objModalEditType.name}
                  onChange={(e) => {
                ...
                <ClayInput
                  type="text"
                  defaultValue={objModalEditType.tax}
                  onChange={(e) => {
                    // setHeadline(e.target.value);
                  }}
                ></ClayInput>
                ...
                <ClayInput
                  type="text"
                  defaultValue={objModalEditType.id}
                  onChange={(e) => {
                    // setHeadline(e.target.value);
                  }}
                ></ClayInput>
