...
import com.liferay.sales.service.SaleTypeLocalService;
...
/**
 * Provides the base implementation for the sale type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.sales.service.impl.SaleTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.sales.service.impl.SaleTypeLocalServiceImpl
 * @generated
 */
public abstract class SaleTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, SaleTypeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SaleTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SaleTypeLocalServiceUtil</code>.
	 */
	...
	public SaleType createSaleType(long typeId) {
		return saleTypePersistence.create(typeId);
	}
	...
	public SaleType deleteSaleType(long typeId) throws PortalException {
		return saleTypePersistence.remove(typeId);
	}
	...
	public SaleType deleteSaleType(SaleType saleType) {
		return saleTypePersistence.remove(saleType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SaleType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return saleTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return saleTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return saleTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return saleTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SaleType fetchSaleType(long typeId) {
		return saleTypePersistence.fetchByPrimaryKey(typeId);
	}
	...
	public SaleType getSaleType(long typeId) throws PortalException {
		return saleTypePersistence.findByPrimaryKey(typeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(saleTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SaleType.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SaleType.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return saleTypePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return saleTypeLocalService.deleteSaleType((SaleType)persistedModel);
	}

	public BasePersistence<SaleType> getBasePersistence() {
		return saleTypePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return saleTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SaleType> getSaleTypes(int start, int end) {
		return saleTypePersistence.findAll(start, end);
	}
	...
	public int getSaleTypesCount() {
		return saleTypePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SaleTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		saleTypeLocalService = (SaleTypeLocalService)aopProxy;

		_setLocalServiceUtilService(saleTypeLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SaleTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = saleTypePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = SaleTypeLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, saleTypeLocalService);
		}
	...
	protected SaleTypeLocalService saleTypeLocalService;
