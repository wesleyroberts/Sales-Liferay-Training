...
/**
 * Provides the local service interface for SaleProduct. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SaleProductLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SaleProductLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.sales.service.impl.SaleProductLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sale product local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SaleProductLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SaleProduct deleteSaleProduct(long productId) throws PortalException;
