...
/**
 * The persistence utility for the sale cart service. This utility wraps <code>com.liferay.sales.service.persistence.impl.SaleCartPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see SaleCartPersistence
 * @generated
 */
public class SaleCartUtil {
	 ...
	 */
	public static void clearCache(SaleCart saleCart) {
		getPersistence().clearCache(saleCart);
	}
	 ...
	 */
	public static Map<Serializable, SaleCart> fetchByPrimaryKeys(
	 ...
	 */
	public static List<SaleCart> findWithDynamicQuery(
	...
	public static List<SaleCart> findWithDynamicQuery(
		DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator<SaleCart> orderByComparator) {
	 ...
	 */
	public static SaleCart update(SaleCart saleCart) {
		return getPersistence().update(saleCart);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static SaleCart update(
		SaleCart saleCart, ServiceContext serviceContext) {

		return getPersistence().update(saleCart, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(SaleCart saleCart) {
		getPersistence().cacheResult(saleCart);
	}
	 ...
	 */
	public static void cacheResult(List<SaleCart> saleCarts) {
		getPersistence().cacheResult(saleCarts);
	}
	 ...
	 */
	public static SaleCart create(long cartId) {
	 ...
	 */
	public static SaleCart remove(long cartId)
		throws com.liferay.sales.exception.NoSuchSaleCartException {

		return getPersistence().remove(cartId);
	}

	public static SaleCart updateImpl(SaleCart saleCart) {
		return getPersistence().updateImpl(saleCart);
	}
	 ...
	 * @throws NoSuchSaleCartException if a sale cart with the primary key could not be found
	 */
	public static SaleCart findByPrimaryKey(long cartId)
		throws com.liferay.sales.exception.NoSuchSaleCartException {
	 ...
	 */
	public static SaleCart fetchByPrimaryKey(long cartId) {
	 ...
	 */
	public static List<SaleCart> findAll() {
	 ...
	 */
	public static List<SaleCart> findAll(int start, int end) {
	...
	public static SaleCartPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<SaleCartPersistence, SaleCartPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(SaleCartPersistence.class);

		ServiceTracker<SaleCartPersistence, SaleCartPersistence>
			serviceTracker =
				new ServiceTracker<SaleCartPersistence, SaleCartPersistence>(
					bundle.getBundleContext(), SaleCartPersistence.class, null);
